...
const LEARN_CARDS = [
  {h:"ا",t:"Ikhfa Haqiqi",x:"Nun sukun/tanwin bertemu 15 huruf dibaca samar.",e:"مِن شَرِّ مَا خَلَقَ",a:"audio/1.mp3"},
 {h:"ب",t:"Iqlab",x:"Nun sukun/tanwin bertemu ba berubah mim dengung.",e:"فَمَن تَابَ",a:"audio/2.mp3"},
 {h:"ت",t:"Izhar",x:"Nun sukun/tanwin bertemu huruf halqi dibaca jelas.",e:"فَصَلِّ لِرَبِّكَ",a:"audio/3.mp3"},
 {h:"ث",t:"Idgham Bighunnah",x:"Nun/tanwin bertemu ي ن م و dibaca dengung.",e:"فَمَنْ يَّعْمَلْ",a:"audio/4.mp3"},
 {h:"ج",t:"Idgham Bila Ghunnah",x:"Nun/tanwin bertemu ل ر dibaca tanpa dengung.",e:"وَلَمْ يَكُن",a:"audio/5.mp3"},
 {h:"ح",t:"Idzhar Syafawi",x:"Mim sukun bertemu selain م dan ب.",e:"لَهُمْ فِيهَا",a:"audio/6.mp3"},
 {h:"خ",t:"Idgham Mimi",x:"Mim sukun bertemu mim dibaca dengung.",e:"لَهُمْ مَا",a:"audio/7.mp3"},
 {h:"د",t:"Ikhfa Syafawi",x:"Mim sukun bertemu ba dibaca samar.",e:"تَرْمِيهِمْ",a:"audio/8.mp3"},
 ...
 $("#cardBox").innerHTML = `
  <div style="position:relative;z-index:5;">
    <div class="card-header">
      ...
      <div class="card-index">${cardIndex+1}/${LEARN_CARDS.length}</div>
    </div>

    <h3>${c.t}</h3>
    <p class="card-desc">${c.x}</p>

    <div class="card-example-box">
      <span>Contoh Bacaan</span>
      <p class="contoh">${c.e}</p>
    </div>
  </div>
 `;
 $("#cardAudio").src = c.a || "";
...
// ====== NAVIGASI KARTU ======
$("#nextCard").onclick = ()=>{
 if(cardIndex < LEARN_CARDS.length-1){
   cardIndex++;
   renderCard();
 }
};
